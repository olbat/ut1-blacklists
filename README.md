...
|:-----|:-----|:------------|
| [adult](blacklists/adult) | 4532034 | Some adult site from erotic to hard pornography |
...
| [audio-video](blacklists/audio-video) | 3845 | Some audio and video sites |
...
| [cryptojacking](blacklists/cryptojacking) | 16266 | Mining site by hijacking |
...
| [examen_pix](blacklists/examen_pix) | 475 | A list reserved exclusively for French students taking the PIX exam. DO NOT USE in other circumstances |
...
| [games](blacklists/games) | 11790 | games sites (flash and online games ) |
...
| [malware](blacklists/malware) | 55334 | Any website which deliver malware |
...
| [phishing](blacklists/phishing) | 55432 | Phishing sites (same as malware category) |
...
| [shortener](blacklists/shortener) | 419 | URLs shortening sites |
...
| [strict_redirector](blacklists/strict_redirector) | 129428 | Same as redirector, but with google, yahoo, and other cache/images search robots |
| [strong_redirector](blacklists/strong_redirector) | 129428 | Same as strict_redirector, but, for google, yahoo, we are only blocking some terms |
...
| [tricheur_pix](blacklists/tricheur_pix) | 54 | DO NOT USE. It s a specific blacklist for french exam |
